...
# # unemprate_rec = recession_data.groupby('Vehicle_Type')[['unemployment_rate','Automobile_Sales']].mean().reset_index()
# # print(unemprate_rec.head(10))
# # unemprate_rec.plot(kind = 'bar', x = 'Vehicle_Type',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemprate_rec = recession_data.groupby('Vehicle_Type')[['unemployment_rate','Automobile_Sales']].mean().reset_index()
        R_chart4 = dcc.Graph(figure = px.bar(unemprate_rec, x = 'Vehicle_Type', y =['unemployment_rate','Automobile_Sales'],title="Effects of Unemployment Rate on Automobile Sales by Vehicle Type during Recession Period"))
        return [
